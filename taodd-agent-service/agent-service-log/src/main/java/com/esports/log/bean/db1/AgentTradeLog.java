...
/**
 * 
* @ClassName: AgentTradeLog 
* @Description: Fund tracking record
* @Author: jacky
* @Version: V1.0
 */
@Entity
@Table(name = "tb_agenttrade_log", indexes = {@Index(name = "account_idx", columnList = "ACCOUNT"),
    @Index(name = "createTime_idx", columnList = "CREATE_TIME")})
@JsonIgnoreProperties(ignoreUnknown = true)
@Data
public class AgentTradeLog implements Serializable {
