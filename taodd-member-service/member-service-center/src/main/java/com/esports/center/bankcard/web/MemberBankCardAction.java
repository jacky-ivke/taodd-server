package com.esports.center.bankcard.web;
...
import com.esports.center.bankcard.web.vo.BankCardVo;
...
public class MemberBankCardAction {
    ...
    @Autowired
    private MemberBankCardManager bankCardManager;

    @ApiOperation("会员提交绑定银行卡信息")

    @RequestMapping(value = "bankcards", produces = "application/json; charset=UTF-8", method = {RequestMethod.POST})
    ...
    @ApiOperation("获取会员绑定的银行卡")

    @RequestMapping(value = "bankcards", produces = "application/json; charset=UTF-8", method = {RequestMethod.GET})
